...
class Elevator(control_loop.ControlLoop):
    ...
    def __init__(self, name = "Elevator") :
        ...
        #radius in meters
        self.r = 0.1 # 4 in
        #mass of the elevator carriage, intake, and ball/hatch is pounds (divide by 2.2 to get kg)
        self.mass = 19.0/2.2 #TODO: find out

        self.max_vel = (self.free_speed/self.G) * (2.0 * numpy.py * self.r)
        ...
        #tolerance of state error
        q_pos = .65
        q_vel = .9
        self.Q = numpy.matrix([[(1.0 / (q_pos ** 2.0)), 0.0],
                           [0.0, (1.0 / (q_vel ** 2.0))]])

        self.R = numpy.matrix([[(1.0 / (12.0 ** 2.0))]]) #penalty for large u
